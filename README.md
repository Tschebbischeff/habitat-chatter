...
![Version](https://img.shields.io/badge/dynamic/json?label=Version&color=yellow&style=flat&url=https%3A%2F%2Fraw.githubusercontent.com%2Ftschebbischeff%2Fhabitat-chatter%2Frefs%2Fheads%2Fmain%2Fmetadata.json&query=%24.version)
...
[![MQTTX Web](https://img.shields.io/badge/MQTTX_Web-_?style=flat&logo=data:image/svg+xml;base64,&logoColor=37DB86&color=gray&labelColor=gray)](https://mqttx.app/)
 ...
 - **MQTT Broker** \
 Real-time communication between modules via a lightweight Eclipse Mosquitto instance
 - **Debugging** \
 MQTTX web interface to allow debugging of messages sent via Mosquitto

### Planned

 - **Backups** \
 Internal backups of Mosquitto SQLite database without downtime to a volume at `VOLUME_DIR`
...
### Run the Application
 ...
 - Visit `mqttx.${APP_HOST}` to visit the MQTTX debugging website
...
<!--
_The configuration of this module is done declaratively via environment variables or via cross-module configuration, generates no user-data and requires supports no backups._
-->
